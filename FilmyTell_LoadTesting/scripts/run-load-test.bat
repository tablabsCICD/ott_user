...
echo Starting FilmyTell Load Test (100 Users, 5 Min Ramp-Up, 30 Min Duration)...
call jmeter.bat -n -t "%TEST_PLAN%" -JTHREAD_COUNT=100 -JRAMP_UP=300 -JDURATION=1800 -JBASE_HOST=filmytell.in -JBASE_PATH=/ott -JENVIRONMENT=QA -l "%RESULT_FILE%" -e -o "%REPORT_DIR%"
