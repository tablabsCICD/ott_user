 ...
 * Handles token authorization, request interceptors, watermarks, and playback state.
 */
...
class FilmyTellPlayerController {
  ...
  setupWatermark(watermarkText) {
    ...
    // Position randomly across corners periodically to prevent screen retention
