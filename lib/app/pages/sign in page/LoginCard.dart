...
class _LoginCardState extends State<LoginCard> with CodeAutoFill {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: ResponsiveWidget.isMobile(context) ? 24 : 24),
                ConstrainedBox(
                                ...
                                FocusTraversalOrder(
                                  ...
                                  child: _TvFocusFrame(
                                    ...
                                    child: TextFormField(
                                      ...
                                      onChanged: (value) {
                                        _mobileNumberForOtp = _digitsOnly(
                                          value,
                                        ).trim();
                                      },
                                      onFieldSubmitted: (_) {
  ...
  void _appendTvDigit(String digit) {
    final controller = otpSent && _editingOtp
        ? _otpController
        : _mobileController;
...
class _TvNumberPadKey {
  const _TvNumberPadKey({this.label, this.icon, required this.onTap});
