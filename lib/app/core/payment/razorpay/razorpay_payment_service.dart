...
import 'package:ott/app/core/payment/razorpay/razorpay_config.dart';
    ...
    try {
      ...
      if (body['success'] == true && body['data'] is Map<String, dynamic>) {
        ...
        return PaymentOrder.fromJson({
          ...
          'amount': data['amount'],
          'currency': data['currency'] ?? RazorpayConfig.defaultCurrency,
      ...
      if (body.containsKey('id') || body.containsKey('orderId')) {
        return PaymentOrder.fromJson({
          ...
          'amount': body['amount'],
          'currency': body['currency'] ?? RazorpayConfig.defaultCurrency,
  ...
  Future<PaymentResult> openCheckout({
    ...
    if (!isSupportedPlatform) {
      return const PaymentResult(
        success: false,
        message: 'Razorpay checkout is only available on web, Android, and iOS.',
    ...
    final razorpayKey = RazorpayConfig.keyId;
    ...
    if (RazorpayConfig.logoUrl.isNotEmpty) {
